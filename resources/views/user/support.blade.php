...
@section('content')
    ...
    <style>
        ...
        .popup {
            ...
            border-radius: 8px;
            width: 800px;
            /* Tăng kích thước popup để chứa cả form và contact-info */
        ...
        .content-container {
            ...
            /* Chia thành hai cột bằng nhau */
            gap: 30px;
            /* Tăng khoảng cách giữa hai cột */
        }
        ...
        .popup .contact-info img {
            width: 200px;
            /* Tăng kích thước hình ảnh QR code */
            margin-top: 20px;
            border-radius: 8px;
