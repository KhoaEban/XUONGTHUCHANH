...
class GeminiChatController extends Controller
{
    ...
    public function send(Request $request)
    {
        ...
        $prompt = <<<PROMPT
            ...
            Các intent hợp lệ gồm: 'course_count', 'category_count', 'lesson_count', 'list_courses', 'explain_lesson', 'payment_count', 'other'.
            Câu: "$userMessage"
        PROMPT;
        ...
        $intentHandlers = [
            ...
            'payment_count' => fn() => $this->reply("Hiện tại, chúng tôi có " . Payment::count() . " khóa học.", $name, false),
